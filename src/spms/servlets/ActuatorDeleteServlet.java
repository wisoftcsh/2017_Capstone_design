...
@WebServlet("/actuator/delete")
public class ActuatorDeleteServlet extends HttpServlet {
  ...
  protected void doPost(
    ...
    try {
      ...
      actuatorDao.deleteActuator(Integer.parseInt(request.getParameter("actuatorId")));
